<template>
    <div class="container">          
        <div class="container">
            <cabeza :usr="usr" v-model="protocolo.tema" tipo="Tesina"></cabeza>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Título</label>
            <input type="text"  class="form-control" v-model="protocolo.titulo" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Debe especificar claramente el qué, es decir, el objeto de estudio.">
        ...
        <div class="form-group">
            ...
            <editor api-key="nbugyxrcgxzt221o0ipcx4yj8r0zsnth1nyfrn4bv9zpodwk" v-model="protocolo.plant" :init="{plugins: 'table help'}" 
            initial-value="
        ...
        <div class="form-group">
            ...
            <editor api-key="nbugyxrcgxzt221o0ipcx4yj8r0zsnth1nyfrn4bv9zpodwk" v-model="protocolo.just" :init="{plugins: 'table help'}" 
            initial-value="
        ...
        <div class="form-group">
            ...
            <editor api-key="nbugyxrcgxzt221o0ipcx4yj8r0zsnth1nyfrn4bv9zpodwk" v-model="protocolo.metodologia" :init="{plugins: 'table help'}" 
            initial-value="
