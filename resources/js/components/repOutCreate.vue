<template>
    <div class="container">       
        ...
        <div class="container">
                <cabeza :usr="usr" v-model="protocolo.tema" tipo="Reporte de autoempleo"></cabeza>
        </div>
        ...
        <div class="form-group">
            <label for="inputEmail4">Planteamiento </label>
             <editor api-key="nbugyxrcgxzt221o0ipcx4yj8r0zsnth1nyfrn4bv9zpodwk" v-model="protocolo.plant" initial-value="
        ...
        <div class="form-group">
            ...
            <editor api-key="nbugyxrcgxzt221o0ipcx4yj8r0zsnth1nyfrn4bv9zpodwk" v-model="protocolo.just" initial-value="
        ...
        <div class="form-group">
            ...
            <editor api-key="nbugyxrcgxzt221o0ipcx4yj8r0zsnth1nyfrn4bv9zpodwk" v-model="protocolo.obj" initial-value="
