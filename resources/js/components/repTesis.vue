       ...
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div v-if="dictamen != 1">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Hipotesis</label>
                    <editor  api-key="nbugyxrcgxzt221o0ipcx4yj8r0zsnth1nyfrn4bv9zpodwk" v-model="cosas.hipotesis" :init="{plugins: 'table help'}"></editor>
